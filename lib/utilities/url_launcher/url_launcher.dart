...
export 'package:url_launcher/url_launcher.dart'
    show BrowserConfiguration, LaunchMode, WebViewConfiguration;
...
abstract final class UrlLauncher {
  ...
  static Future<bool> launch(
    ...
    launcher.LaunchMode? fallbackMode,
    launcher.WebViewConfiguration webViewConfiguration =
        const launcher.WebViewConfiguration(),
    launcher.BrowserConfiguration browserConfiguration =
        const launcher.BrowserConfiguration(),
  ...
  static Future<bool> supportsMode(launcher.LaunchMode mode) async {
    try {
      return await launcher.supportsLaunchMode(mode);
    } catch (error, stackTrace) {
      _debugLog(
...
Future<bool> _tryLaunch(
  Uri uri, {
  required launcher.LaunchMode mode,
  required launcher.WebViewConfiguration webViewConfiguration,
  required launcher.BrowserConfiguration browserConfiguration,
  String? webOnlyWindowName,
}) async {
  try {
...
Uri? _parseWebUri(String? url, {required bool addHttpsScheme}) {
  ...
  final String normalizedUrl =
      hasScheme || !addHttpsScheme ? trimmedUrl : 'https://$trimmedUrl';
...
String? _normalizePhoneNumber(String? phoneNumber) {
  ...
  return phone.isPhoneNumber ? phone : null;
}

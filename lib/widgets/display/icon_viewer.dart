...
class IconViewer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final iconWidth = width ?? 30;
    final iconHeight = height ?? 30;
    final size = Size.fromRadius(iconSize ?? 20);
    ...
    if (icon != null) {
      ...
      return isSelected
          ? Container(
            ...
            child: Image.asset(iconImage!, color: selectedIconColor, key: key),
          )
      ...
      return isSelected
          ? Container(
            ...
            child: Text(
              text ?? '',
              style: TextStyle(fontSize: 8, color: selectedIconColor),
            ),
          )
          : Container(
            width: iconWidth,

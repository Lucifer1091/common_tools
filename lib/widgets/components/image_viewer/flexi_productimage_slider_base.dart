...
class FlexiProductimageSlider extends StatelessWidget {
  ...
  Widget buildContent() {
    switch (sliderStyle) {
      case SliderStyle.overSlider:
        return buildTheme1();

      case SliderStyle.nextToSlider:
        return buildTheme2();
  ...
  Widget buildTheme1() {
    return AspectRatio(
      ...
      child: Stack(
        children: [
          Positioned.fill(child: buildImageSlider()),

          if (thumbnailAlignment == ThumbnailAlignment.bottom)
            Positioned(
              left: 0,
              bottom: 5,
              right: 0,
  ...
  Widget buildTheme2() {
    return thumbnailAlignment == ThumbnailAlignment.bottom
        ? Column(
          children: [
            AspectRatio(aspectRatio: aspectRatio!, child: buildImageSlider()),
        ...
        : AspectRatio(
          ...
          child: Row(
            children: [
              if (thumbnailAlignment == ThumbnailAlignment.left)
                Padding(
              ...
              if (thumbnailAlignment == ThumbnailAlignment.right)
                Padding(
                  padding: EdgeInsets.only(left: 5, right: 5),
                  child: buildThumbnail(isVertical: true),
                )
  ...
  Widget buildThumbnail({required bool isVertical}) {
    return Container(
      width:
          isVertical ? thumbnailWidth! + paddingOfBorder + 10 : double.infinity,
      height:
          isVertical
              ? double.infinity
              : thumbnailHeight! + paddingOfBorder + 10,
        ...
        builder: (BuildContext context, currIndexValue, child) {
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              return Padding(
                padding:
                    isVertical ? EdgeInsets.zero : EdgeInsets.only(left: 5),
                child: Column(
                  children: [
                    InkWell(
                      onTap: () {
  ...
  static CachedNetworkImage funcDisplayImage(
    String strImageURL,
    BoxFit varBoxType,
  ) {
      ...
      imageBuilder:
          (context, imageProvider) => Container(
            decoration: BoxDecoration(
              image: DecorationImage(image: imageProvider, fit: varBoxType),
            ),
          ),
      errorWidget:

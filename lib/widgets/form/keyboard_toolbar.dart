...
/// {@endtemplate}
class MyKeyboardToolbar extends StatefulWidget {
  /// {@macro MyKeyboardToolbar}
  const MyKeyboardToolbar({
    required this.child,
  ...
  @override
  State<MyKeyboardToolbar> createState() => _MyKeyboardToolbarState();
}

class _MyKeyboardToolbarState extends State<MyKeyboardToolbar>
  ...
  Widget build(BuildContext context) {
    ...
    final effectiveHideThreshold = widget.hideThreshold ?? 20.0;

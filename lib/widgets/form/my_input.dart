...
///
/// The [MyInput] widget provides a styled text field with support for
/// placeholders, leading/trailing decorations, and extensive text editing
/// features. It supports advanced interactions like selection, context menus,
/// and autofill.
class MyInput extends StatefulWidget {
  ...
  /// {@template MyInput.onPressedOutside}
  ...
  /// {@template MyInput.scrollbarPadding}
...
class MyInputState extends State<MyInput>
  ...
  Widget build(BuildContext context) {
    ...
    final effectiveTextStyle = theme.typography.bodyMedium
    ...
    final effectiveCursorWidth = widget.cursorWidth ?? 2.0;

    final effectiveCursorHeight = widget.cursorHeight;

    final effectiveCursorRadius = widget.cursorRadius;
    ...
    final effectivePlaceholderStyle = theme.typography.bodyMedium
    ...
    final effectivePlaceholderAlignment =
        widget.placeholderAlignment ?? defaultAlignment;

    final effectiveAlignemnt = widget.alignment ?? defaultAlignment;
...
class _InputSelectionGestureDetectorBuilder
  ...
  _InputSelectionGestureDetectorBuilder({required MyInputState state})
    : _state = state,
      super(delegate: state);

  final MyInputState _state;

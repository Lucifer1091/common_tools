...
class IconTextButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (icon != null) {
      ...
      if (disabledIconColor != null) {
        iconChild = IconTheme.merge(
          data: IconThemeData(color: disabledIconColor),
          child: icon!,
        );
      }
      if (isSelected) {
        iconChild = IconTheme.merge(
          data: IconThemeData(color: highlightColor ?? theme.highlightColor),
    ...
    if (label != null) {
      ...
      labelWidget = Text(label!, style: customLabelStyle);
    }
    ...
    Widget toolBarButton = InkResponse(
      key: widgetKey,
      onTap: onTap,
      onTapDown: (details) => onTapDown?.call(details, widgetKey),
      ...
      child: Column(
        ...
        children: [
          AnimatedSwitcher(duration: Durations.short1, child: iconWidget),
          const Space.h4(),
          imageWidget,
          labelWidget,
        ],

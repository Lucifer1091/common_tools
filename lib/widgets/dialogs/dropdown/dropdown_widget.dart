...
enum DropDownExpandType { down, up, center }

class DropDownWidgetItem {
  DropDownWidgetItem({required this.value, this.key, this.id});
  final Key? key;
  final String? id;
  final String value;
...
class DropDownWidget extends StatefulWidget {
  ...
  final void Function(DropDownWidgetItem item, int indexSelected)? onChanged;
...
class DropDownWidgetState extends State<DropDownWidget> {
  ...
  Widget build(BuildContext context) {
    return Stack(
      key: _globalKey,
      children: <Widget>[_buildButton(), if (widget.showArrow) _buildArrow()],
    );
  }
  ...
  double get _getHeightList => min(
    widget.height * widget.data.length,

    ...
    return MouseRegion(
      ...
      child: GestureDetector(
        ...
        child: ValueListenableBuilder<bool>(
          valueListenable: _hoveredNotifier,
          builder:
              (BuildContext context, bool isHovered, Widget? _) =>
...
class _HoverMetrics {
  ...
  factory _HoverMetrics.fromPointer({
    ...
    return _HoverMetrics(
      ...
      rotateX:
          isDefaultPosition ? 0.0 : AnimatedHoverState._maxTilt * translatedY,
      rotateY:
          isDefaultPosition ? 0.0 : -AnimatedHoverState._maxTilt * translatedX,
    );
  }

...
class DiagonalPainter extends BoxPainter {
  ...
  void paint(Canvas canvas, Offset offset, ImageConfiguration configuration) {
    ...
    final double widthf = rect.width / 2.0;
    final double heightf = rect.height / 2.0;
    path.moveTo(position.dx, position.dy);
    for (int i = 0; i < widthf / distanceBetweenLines * 2; i++) {
      path
        ..relativeMoveTo(-distanceBetweenLines * i, 0)
        ..relativeMoveTo(widthf, -heightf)
        ..relativeLineTo(-widthf * 2, heightf * 2)

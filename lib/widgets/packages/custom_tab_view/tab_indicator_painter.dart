...
class ContainerTabIndicator extends Decoration {
  ...
  @override
  ContainerTabPainter createBoxPainter([VoidCallback? onChanged]) {
    return ContainerTabPainter(onChanged, indicator: this);
  }
}

class ContainerTabPainter extends BoxPainter {
  ContainerTabPainter(
    super.onChanged, {

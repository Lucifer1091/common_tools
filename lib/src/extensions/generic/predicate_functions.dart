...
extension BooleanPredicateExtensions on bool Function() {
  ...
  /// print(isGoodDay()); // false
  /// ```
  bool Function() and(bool Function() predicate) =>
      () => this() && predicate();
  ...
  /// ```
  bool Function() or(bool Function() predicate) =>
      () => this() || predicate();
...
extension UnaryBooleanPredicateExtensions<P> on bool Function(P) {
  ...
  /// ```
  bool Function(A) contramap<A>(P Function(A a) map) =>
      (a) => this(map(a));
}

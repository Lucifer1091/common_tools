...
/// Extra metadata and file-type helpers for [MyPickedFile].
///
/// Type checks are based on detected MIME type first, then file extension.
extension FileExtensionX on MyPickedFile {
  ...
  /// MIME type inferred from file path, then fallback to [MyPickedFile.mimeType].

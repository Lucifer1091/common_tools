...
class _RepeatedAnimationBuilderState<T>
  ...
  void _configureAnimation() {
    _controller.duration = _startsReversed
        ? widget.reverseDuration ?? widget.duration
        : widget.duration;
    _controller.reverseDuration = _startsReversed
        ? widget.duration
        : widget.reverseDuration;

    _curvedAnimation = CurvedAnimation(
      parent: _controller,
      curve: _startsReversed
          ? widget.reverseCurve ?? widget.curve
          : widget.curve,
      reverseCurve: _startsReversed
          ? widget.curve
          : widget.reverseCurve ?? widget.curve,
    );

...
class MyDropCapText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final _MarkdownParser? mdData = parseInlineMarkdown
        ? _MarkdownParser(data)
        : null;
    ...
    final _MarkdownParser? mdRest = parseInlineMarkdown
    ...
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        if (rows > 0) {
          ...
          final int charIndex = textPainter
              ...
              children: <Widget>[
                ...
                Flexible(
                  child: Container(
                    ...
                    width: boundsWidth,
                    height: mode != MyDropCapMode.aside
  ...
  _MarkdownParser(this.data) {
    ...
    void addSpan(String markup, bool isOpening) {
      ...
      if (bold && markup != markupBold) {
        markups.add(_Markup(markupBold, true));
      }
      if (italic && markup != markupItalic) {
        markups.add(_Markup(markupItalic, true));
      }
      if (underline && markup != markupUnderline) {
        markups.add(_Markup(markupUnderline, true));
      }

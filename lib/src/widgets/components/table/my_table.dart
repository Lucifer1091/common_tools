...
import '../checkbox/my_check_box.dart';
import '../error/my_error.dart';
...
class MyTableState extends State<MyTable> {
  ...
  Widget _getTableContent(BuildContext context) {
    ...
    for (var i = 0; i < widget.data!.length; i++) {
      ...
      cells.add(
        ColoredBox(
          color: (widget.stripe ?? false) && i.isEven
              ...
              child: MyGestureDetector(
                ...
                child: CustomPaint(
                  ...
                  painter: ChevronPainter(
                    upColor: (_sortable ?? false) && (_sortKey == column.field)
                        ? selectColor
                        : unSelectColor,
                    downColor:
...
class ChevronPainter extends CustomPainter {
  ...
  bool shouldRepaint(covariant ChevronPainter oldDelegate) {
    return oldDelegate.upColor != upColor || oldDelegate.downColor != downColor;
  }
}

...
import '../tag/my_tag.dart';
import '../tag/my_tag_styles.dart';
...
class MySelectState<T> extends State<MySelect<T>> {
  ...
  Widget _buildSelectedChips(BuildContext context, List<T> values) {
    final onRemoved = widget.enabled && widget.allowDeselection
        ? deselect
        : null;
  ...
  FutureOr<MySelectItemDelegate?> _resolveItems(
    ...
    final normalizedSearch = searchQuery == null || searchQuery.isEmpty
        ? null
        : searchQuery;
              ...
              child: MyPopover(
                ...
                popover: (_) {
                  final items = hasSearch
                      ...
                      : _buildResolvedItems(context, effectiveOptionsPadding);

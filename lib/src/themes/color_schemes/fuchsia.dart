...
@immutable
class MyFuchsiaColorScheme extends MyColorScheme {
  const MyFuchsiaColorScheme({
  ...
  const MyFuchsiaColorScheme.light({
    ...
    super.primary = const Color(0xffa800b7),
    super.primaryForeground = const Color(0xfffdf4ff),
    ...
    super.selection = const Color(0x47a800b7),
    super.chart1 = const Color(0xfff4a8ff),
    super.chart2 = const Color(0xffe12afb),
    super.chart3 = const Color(0xffc800de),
    super.chart4 = const Color(0xffa800b7),
    super.chart5 = const Color(0xff8a0194),
  });
  ...
  const MyFuchsiaColorScheme.dark({
    ...
    super.primary = const Color(0xff8a0194),
    super.primaryForeground = const Color(0xfffdf4ff),
    ...
    super.selection = const Color(0x478a0194),
    super.chart1 = const Color(0xfff4a8ff),
    super.chart2 = const Color(0xffe12afb),
    super.chart3 = const Color(0xffc800de),
    super.chart4 = const Color(0xffa800b7),

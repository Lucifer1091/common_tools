...
@immutable
class MyIndigoColorScheme extends MyColorScheme {
  const MyIndigoColorScheme({
  ...
  const MyIndigoColorScheme.light({
    ...
    super.primary = const Color(0xff432dd7),
    super.primaryForeground = const Color(0xffeef2ff),
    ...
    super.selection = const Color(0x47432dd7),
    super.chart1 = const Color(0xffa3b3ff),
    super.chart2 = const Color(0xff615fff),
    super.chart3 = const Color(0xff4f39f6),
    super.chart4 = const Color(0xff432dd7),
    super.chart5 = const Color(0xff372aac),
  });
  ...
  const MyIndigoColorScheme.dark({
    ...
    super.primary = const Color(0xff372aac),
    super.primaryForeground = const Color(0xffeef2ff),
    ...
    super.selection = const Color(0x47372aac),
    super.chart1 = const Color(0xffa3b3ff),
    super.chart2 = const Color(0xff615fff),
    super.chart3 = const Color(0xff4f39f6),
    super.chart4 = const Color(0xff432dd7),

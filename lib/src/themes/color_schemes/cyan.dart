...
@immutable
class MyCyanColorScheme extends MyColorScheme {
  const MyCyanColorScheme({
  ...
  const MyCyanColorScheme.light({
    ...
    super.primary = const Color(0xff007595),
    super.primaryForeground = const Color(0xffecfeff),
    ...
    super.selection = const Color(0x47007595),
    super.chart1 = const Color(0xff53eafd),
    super.chart2 = const Color(0xff00b8db),
    super.chart3 = const Color(0xff0092b8),
    super.chart4 = const Color(0xff007595),
    super.chart5 = const Color(0xff005f78),
  });
  ...
  const MyCyanColorScheme.dark({
    ...
    super.primary = const Color(0xff005f78),
    super.primaryForeground = const Color(0xffecfeff),
    ...
    super.selection = const Color(0x47005f78),
    super.chart1 = const Color(0xff53eafd),
    super.chart2 = const Color(0xff00b8db),
    super.chart3 = const Color(0xff0092b8),
    super.chart4 = const Color(0xff007595),

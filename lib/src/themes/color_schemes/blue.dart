...
@immutable
class MyBlueColorScheme extends MyColorScheme {
  const MyBlueColorScheme({
  ...
  const MyBlueColorScheme.light({
    ...
    super.primary = const Color(0xff1447e6),
    super.primaryForeground = const Color(0xffeff6ff),
    ...
    super.selection = const Color(0x471447e6),
    super.chart1 = const Color(0xff8ec5ff),
    super.chart2 = const Color(0xff2b7fff),
    super.chart3 = const Color(0xff155dfc),
    super.chart4 = const Color(0xff1447e6),
    super.chart5 = const Color(0xff193cb8),
  });
  ...
  const MyBlueColorScheme.dark({
    ...
    super.primary = const Color(0xff193cb8),
    super.primaryForeground = const Color(0xffeff6ff),
    ...
    super.selection = const Color(0x47193cb8),
    super.chart1 = const Color(0xff8ec5ff),
    super.chart2 = const Color(0xff2b7fff),
    super.chart3 = const Color(0xff155dfc),
    super.chart4 = const Color(0xff1447e6),

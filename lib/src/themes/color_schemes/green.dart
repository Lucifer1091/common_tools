...
@immutable
class MyGreenColorScheme extends MyColorScheme {
  const MyGreenColorScheme({
  ...
  const MyGreenColorScheme.light({
    ...
    super.primary = const Color(0xff008236),
    super.primaryForeground = const Color(0xfff0fdf4),
    ...
    super.selection = const Color(0x47008236),
    super.chart1 = const Color(0xff7bf1a8),
    super.chart2 = const Color(0xff00c950),
    super.chart3 = const Color(0xff00a63e),
    super.chart4 = const Color(0xff008236),
    super.chart5 = const Color(0xff016630),
  });
  ...
  const MyGreenColorScheme.dark({
    ...
    super.primary = const Color(0xff016630),
    super.primaryForeground = const Color(0xfff0fdf4),
    ...
    super.selection = const Color(0x47016630),
    super.chart1 = const Color(0xff7bf1a8),
    super.chart2 = const Color(0xff00c950),
    super.chart3 = const Color(0xff00a63e),
    super.chart4 = const Color(0xff008236),

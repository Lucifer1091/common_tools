...
@immutable
class MyVioletColorScheme extends MyColorScheme {
  const MyVioletColorScheme({
  ...
  const MyVioletColorScheme.light({
    ...
    super.primary = const Color(0xff7008e7),
    super.primaryForeground = const Color(0xfff5f3ff),
    ...
    super.selection = const Color(0x477008e7),
    super.chart1 = const Color(0xffc4b4ff),
    super.chart2 = const Color(0xff8e51ff),
    super.chart3 = const Color(0xff7f22fe),
    super.chart4 = const Color(0xff7008e7),
    super.chart5 = const Color(0xff5d0ec0),
  });
  ...
  const MyVioletColorScheme.dark({
    ...
    super.primary = const Color(0xff5d0ec0),
    super.primaryForeground = const Color(0xfff5f3ff),
    ...
    super.selection = const Color(0x475d0ec0),
    super.chart1 = const Color(0xffc4b4ff),
    super.chart2 = const Color(0xff8e51ff),
    super.chart3 = const Color(0xff7f22fe),
    super.chart4 = const Color(0xff7008e7),

...
class _TDThemeColorsPageState extends State<TDThemeColorsPage> {
  ...
  Widget build(BuildContext context) {
    return ExamplePage(
      ...
      children: [
        ...
        //     ExampleItem(
        //       desc: '功能色',
        //       builder: _buildFunctionColor,
        //       ignoreCode: true,
        //     ),
        //     ExampleItem(
        //       desc: '文字&图标颜色',
        //       builder: _buildTextColor,
        //       ignoreCode: true,
        //     ),
        //     ExampleItem(
        //       desc: '中性色板',
        //       builder: _buildOtherColor,
        //       ignoreCode: true,
        //     ),
        //   ],
        // ),
  ...
  //         color: ThemeColors.neutral.shade50, // 颜色
  //         borderRadius: BorderRadius.circular(MyRadius.medium), // 圆角
  //         boxShadow: TDTheme.of(context).shadowsBase, // 阴影
  //       ),
  //       child: TDText(
  //         '使用外层默认主题',
  //         , // 字体，业务方使用时，
  //         textColor: context.colorScheme.primary, // 颜色，AS中点击颜色可查看具体设置和显示效果
  //       ),
  //     );
  //   }
  ...
  //       data: TDTheme.of(context).copyWithTDThemeData(
  //         'custom',
  ...
  //     //             , //明确使用内层主题，必须传context
  //     //             textColor:
  //     //                 context.colorScheme.primary, // 明确使用内层主题，必须传context
  //     //           ),
  //     //           TDText(
  //     //             '使用内层不赋值主题',
  ...
  //             '使用内层赋值主题',
  //             , //明确使用内层主题，必须传context
  //             textColor: context.colorScheme.primary, // 明确使用内层主题，必须传context
  //           ),
  //           TDText(
  //             '使用内层不赋值主题',
  //             font: TDTheme.of(context).fontTitleExtraLarge, //明确使用内层主题，必须传context
  ...
  //               context,
  //             ).successNormalColor, // 明确使用内层主题，必须传context
  //           ),
  //           const TDButton(text: '使用内层赋值主题', theme: TDButtonTheme.primary),
  //           TDText(
  //             '使用默认主题',
  //             font:

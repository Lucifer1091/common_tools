    ...
    var childBuilder = (context) {
      return ExamplePage(
        ...
        children: [
          ExampleModule(
            ...
            children: [
              ...
              ExampleItem(
                desc: '带图标输入框',
                builder: _basicTypeWithLeftIconLeftLabel,
              ),
        ...
        test: [
          ...
          ExampleItem(
            desc: '获取焦点时点击外部区域事件响应-onTapOutside',
            builder: _onTapOutside,
          ),
          ExampleItem(
            desc: '设置contentPadding内容与分割线对齐',
            builder: _contentPadding,
          ),
        ],
      );
    };
    ...
    return Column(
      children: [
        TDInput(
          ...
          backgroundColor: Colors.white,
          rightBtn: browseOn
              ? Icon(TDIcons.browse, color: TDTheme.of(context).fontGyColor3)
              : Icon(
                  TDIcons.browse_off,
                  color: TDTheme.of(context).fontGyColor3,
                ),

  ...
  return TDBottomTabBar(
    ...
    navigationTabs: [
      TDBottomTabBarTabConfig(
        ...
        unselectedIcon:
            Icon(TDIcons.home, size: iconSize, color: const Color(0xFF383838)),
        tabText: '首页',
      ...
      TDBottomTabBarTabConfig(
        ...
        unselectedIcon:
            Icon(TDIcons.app, size: iconSize, color: const Color(0xFF383838)),
        tabText: '办事',
        selectTabTextStyle: TextStyle(fontSize: textSize, color: Colors.red),
        unselectTabTextStyle:
            TextStyle(fontSize: textSize, color: Colors.black),
      ...
      TDBottomTabBarTabConfig(
        ...
        unselectedIcon:
            Icon(TDIcons.user, size: iconSize, color: Color(0xFF383838)),
        tabText: '我的',
        selectTabTextStyle: TextStyle(fontSize: textSize, color: Colors.red),
        unselectTabTextStyle:
            TextStyle(fontSize: textSize, color: Colors.black),
